...
const Header = () => {
  ...
  return (
    <div className='sticky z-10 header top-0 text-3xl flex justify-between items-center text-red-600
    font-bold p-6 border-b-2 border-gray-500'>
        <Link to={'/'}><span>Movie<span className='text-white'>X</span></span></Link>
        {useAppstate.login ? 
